...
export class LandingpagePage {
  ...
  constructor(private storage: Storage,
    ...
    // showpass parameter
    // alert(this.navParams.get('showPass'));
    ...
    //   this.sPass = false;
    // }
    // if(this.navParams.get('showPass') == true){
    //   this.sPass = true;
    // }else{
    //   this.sPass = false;
    // }
  ...
  ionViewDidLoad() {
    ...
    // console.log('Spass:', this.sPass);alert(this.sPass);

    if (this.sPass == true) { //sPass = true; if user gets into LandingPage for payment
      //Call api without weblink (Weblinks are payment free)
      this.ajax.postMethodct('get-all-competitions-v1').subscribe((res) => {
        console.log(res);
        this.competitionlist = res;
        console.log(this.competitionlist);
      })
    } else if (this.sPass == false) { //sPass = false; if user gets into LandingPage for first time
      //Call api with weblink
