...
export class ProductListProvider {
  ...
  SetUserProduct(team, competition, year) {
   ...
   console.log(competition)
    ...
    }else if (team.team_id == 532 && competition.competition_id == 67 && year == 2019) {
      this.product = this.ProductList["532"];
    }else if (team.team_id == 533 && competition.competition_id == 67 && year == 2019) {
      this.product = this.ProductList["533"];
    }else if (team.team_id == 534 && competition.competition_id == 67 && year == 2019) {
      this.product = this.ProductList["534"];
    }else if (team.team_id == 535 && competition.competition_id == 67 && year == 2019) {
      this.product = this.ProductList["535"];
    }else if (team.team_id == 536 && competition.competition_id == 67 && year == 2019) {
      this.product = this.ProductList["536"];
    }else if (team.team_id == 537 && competition.competition_id == 67 && year == 2019) {
